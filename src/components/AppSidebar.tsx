import { BarChart3, Briefcase, Bell, CandlestickChart, LayoutDashboard, Layers, Moon, ScanLine, Settings, Star, Sun, TableProperties, Zap, Brain, LineChart, Activity, Shapes } from "lucide-react";
...
const mainItems = [
  ...
  { title: "Index OI Insights", url: "/index-oi-insights", icon: LineChart },
  { title: "Index Move Alerts", url: "/index-move-alerts", icon: Bell },
  { title: "Smallcap Stock Alerts", url: "/smallcap-stock-alerts", icon: Activity },
  { title: "TA Scanner", url: "/ta-scanner", icon: ScanLine, shortcut: "7" },
  { title: "3-Candle Scanner", url: "/three-candle-scanner", icon: CandlestickChart, shortcut: "8" },
  { title: "Chart Patterns", url: "/chart-pattern-scanner", icon: Shapes },
  { title: "Algo Strategies", url: "/strategy-scanner", icon: Brain, shortcut: "0" },
  { title: "F&O Intelligence", url: "/fno-intelligence", icon: Zap, shortcut: "9" },
