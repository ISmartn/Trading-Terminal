...
import { TechnicalSnapshotRow } from "@/components/TechnicalSnapshot";
import { FnoIntelligenceWidget } from "@/components/dashboard/FnoIntelligenceWidget";
    ...
    <ErrorBoundary fallbackMessage="Dashboard failed to load">
      <div className="space-y-3 animate-fade-in">
        ...
        <SectionHeader
          ...
          subtitle="Live movers + next-day playbook — auto-scanned"
          icon={<Zap className="h-4 w-4" />}
          tooltip="During market hours, surfaces F&O stocks with quick move potential (bullish & bearish). After close, open the hub for tomorrow's playbook."
        />
        <FnoIntelligenceWidget />

        {/* ═══ TECHNICAL SNAPSHOT (TA-Lib) ═══ */}
        <SectionHeader
          title="Technical Snapshot"
          subtitle="RSI, ADX, ATR, MACD & patterns via TA-Lib"
          icon={<Activity className="h-4 w-4" />}
          tooltip="Spot trend context from TA-Lib indicators. Click a card to open the chart with overlays. See https://ta-lib.org/"
        />
