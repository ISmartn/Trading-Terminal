...
export default function OIAnalysis() {
  ...
  return (
    <div className="space-y-4">
      ...
      <SpotContextStrip symbol={symbol} spotPrice={spotPrice} />
          ...
          <CardContent className="py-12 space-y-5">
            <div className="text-center">
              ...
              <p className="text-xs text-muted-foreground mt-1.5 max-w-md mx-auto leading-relaxed">
                Data refreshes automatically during market hours. Check that the proxy server is running on port <code className="font-mono text-primary/70 bg-primary/10 px-1 rounded">{getProxyPortLabel()}</code>.
              </p>
            </div>
