...
export const BROKERS: BrokerInfo[] = [
  {
    ...
    logo: "🟣",
    color: "hsl(271 76% 53%)",
    description: "Primary data source — Upstox API v2/v3 with option chain, Greeks, historical data, and live LTP feed.",
    docsUrl: "https://upstox.com/developer/api-documentation/open-api/",
    features: ["Option Chain", "Greeks", "Live LTP", "Historical Data", "Instrument Master"],
    fields: [
      { key: "apiKey", label: "API Key", placeholder: "Enter Upstox API Key", type: "text", required: false, helpText: "From Upstox Developer Console (needed for OAuth login flow)" },
      { key: "apiSecret", label: "API Secret", placeholder: "Enter Upstox API Secret", type: "password", required: false },
      { key: "accessToken", label: "Access Token", placeholder: "Enter OAuth Access Token", type: "password", required: true, helpText: "Generate via OAuth2 redirect flow — required for market data" },
    ],
  },
  {
    id: "dhan",
    ...
    logo: "🟢",
    color: "hsl(142 71% 45%)",
    description: "Legacy broker slot (not wired in this build — use Upstox for live data).",
