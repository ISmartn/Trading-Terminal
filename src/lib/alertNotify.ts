/**
 * Cross-tab alert delivery: sound, browser notifications, title flash, toast.
 */
...
const PREFS_KEY = "trading-terminal-alert-notify-prefs";
...
export interface NotifyUserAlertOptions {
  ...
  tone?: AlertTone;
  tag?: string;
  /** Show Sonner toast (default: true when tab is focused). */
  toast?: boolean;
  sound?: boolean;
  browser?: boolean;
  /** Flash tab title when document is hidden (default: true). */
  flashTitle?: boolean;
}
